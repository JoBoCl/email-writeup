...
presented to the user.  This chapter presents each of these stages in detail.
  ...
  \paragraph{MITRE CVE Lookup and Norton Vulnerability Protection}
...
\draw (0,3) rectangle node [align=center, text width = 3.5cm]{ID, IP Address, Latitude, Longitude, Software} (4,5);
\draw [->] (2,2) -- (2,3);
\end{tikzpicture}
\caption{Device Info Data Structure}
\end{figure}
