...
the CVE Database lookup, followed by the WhoIs lookup and then the GeoIP
lookup.  The CVE database lookups require the most time as they are often
...
\begin{algorithm}
	...
	\lForEach{$s_i\in\text{servers}$}{project $s_i$ onto map}
